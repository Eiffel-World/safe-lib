indexing
	...
	date: 		"$Date: 2003/02/25 21:02:24 $"
	revision: 	"$Revision: 1.1.2.1 $"
	licensing: 	"See notice at end of class"

class
	ECLI_ABSTRACT_STATEMENT [G_VAL -> ECLI_VALUE, G_PRM -> ECLI_VALUE]
...
feature -- Access
	...
	parameter (name : STRING) : G_PRM is
...
feature -- Element change
	...
	set_parameters (param : ARRAY[G_PRM]) is
	...
	put_parameter (value : G_PRM; key : STRING) is
...
end -- class ECLI_ABSTRACT_STATEMENT
--

...
deferred class
	ECLI_ABSTRACT_ROW_CURSOR [G_VAL -> ECLI_VALUE, G_PRM -> ECLI_VALUE]

inherit
	ECLI_ABSTRACT_CURSOR [G_VAL, G_PRM]
		rename
...
--	item_by_index, infix "|index|" (index : INTEGER) : like value_anchor is
	item_by_index (index : INTEGER) : G_VAL is
...
feature {NONE} -- Implementation
	...
	buffer_factory : ECLI_ABSTRACT_BUFFER_FACTORY [G_VAL]
...
end -- class ECLI_ABSTRACT_ROW_CURSOR

indexing
	...
	date: "$Date: 2003/02/25 21:02:25 $"
	revision: "$Revision: 1.1.2.1 $"

deferred class
	ECLI_ABSTRACT_BUFFER_FACTORY [G_VAL -> ECLI_VALUE]
...
feature {NONE} -- Implementation
	...
	value_factory : ECLI_ABSTRACT_VALUE_FACTORY [G_VAL] is
		deferred
		end		
...
end -- class ECLI_ABSTRACT_BUFFER_FACTORY

...
feature {NONE} -- Initilization.
	...
	make (parent: CURSES_WINDOW; a_height, a_width, y, x: INTEGER) is
		...
		do
			...
			!EFMT_INTEGER_FORMATTER!display_formatter.make (window.width)

			!EFMT_INTEGER_FORMATTER!edit_formatter.make (window.width)
...
feature -- Status report
	...
	display_formatter: EFMT_INTEGER_FORMATTER
			-- Formatter for displaying.

	edit_formatter: EFMT_INTEGER_FORMATTER

indexing
	description: "Makes the next child current in a ECTK_CONTAINER"
	author: "Fafchamps Eric"
	date: "$Date: 2001/11/28 10:24:46 $"
	revision: "$Revision: 1.2 $"

class
	ECTK_CONTAINER_FORTH_COMMAND
...
feature -- Status setting
	...
	check_precondition: BOOLEAN is
		...
		do
			if  not container.off and then not container.is_last then
...
end -- class ECTK_CONTAINER_FORTH_COMMAND

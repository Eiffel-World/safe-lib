...
-- wrapper for struct: struct tagPOLYTEXTA-- WARNING: could not find good typename, wrapper may contain errors

class TAG_POLYTEXTA_STRUCT_EXTERNAL
...
feature {NONE} -- Implementation
	...
	get_x_external (item: POINTER): INTEGER is
		...
		alias
			"ewg_struct_macro_struct_tagPOLYTEXTA_member_get_x"
	...
	set_x_external (a_item: POINTER; a_value: INTEGER) is
		external
			...
			"C [macro <c\struct\ewg_struct_c_glue_code.h>]"
		alias
			"ewg_struct_macro_struct_tagPOLYTEXTA_member_set_x"
	...
	get_y_external (item: POINTER): INTEGER is
		external
			...
			"C [macro <c\struct\ewg_struct_c_glue_code.h>]"
		alias
			"ewg_struct_macro_struct_tagPOLYTEXTA_member_get_y"
	...
	set_y_external (a_item: POINTER; a_value: INTEGER) is
		external
			...
			"C [macro <c\struct\ewg_struct_c_glue_code.h>]"
		alias
			"ewg_struct_macro_struct_tagPOLYTEXTA_member_set_y"
	...
	get_n_external (item: POINTER): INTEGER is
		external
			...
			"C [macro <c\struct\ewg_struct_c_glue_code.h>]"
		alias
			"ewg_struct_macro_struct_tagPOLYTEXTA_member_get_n"
	...
	set_n_external (a_item: POINTER; a_value: INTEGER) is
		external
			...
			"C [macro <c\struct\ewg_struct_c_glue_code.h>]"
		alias
			"ewg_struct_macro_struct_tagPOLYTEXTA_member_set_n"
	...
	get_lpstr_external (item: POINTER): POINTER is
		external
			...
			"C [macro <c\struct\ewg_struct_c_glue_code.h>]"
		alias
			"ewg_struct_macro_struct_tagPOLYTEXTA_member_get_lpstr"
	...
	set_lpstr_external (a_item: POINTER; a_value: POINTER) is
		external
			...
			"C [macro <c\struct\ewg_struct_c_glue_code.h>]"
		alias
			"ewg_struct_macro_struct_tagPOLYTEXTA_member_set_lpstr"
	...
	get_uiflags_external (item: POINTER): INTEGER is
		external
			...
			"C [macro <c\struct\ewg_struct_c_glue_code.h>]"
		alias
			"ewg_struct_macro_struct_tagPOLYTEXTA_member_get_uiFlags"
	...
	set_uiflags_external (a_item: POINTER; a_value: INTEGER) is
		external
			...
			"C [macro <c\struct\ewg_struct_c_glue_code.h>]"
		alias
			"ewg_struct_macro_struct_tagPOLYTEXTA_member_set_uiFlags"
	...
	get_pdx_external (item: POINTER): POINTER is
		external
			...
			"C [macro <c\struct\ewg_struct_c_glue_code.h>]"
		alias
			"ewg_struct_macro_struct_tagPOLYTEXTA_member_get_pdx"
	...
	set_pdx_external (a_item: POINTER; a_value: POINTER) is
		external
			...
			"C [macro <c\struct\ewg_struct_c_glue_code.h>]"
		alias
			"ewg_struct_macro_struct_tagPOLYTEXTA_member_set_pdx"

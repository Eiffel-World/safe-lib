class OLDFONTENUMPROCW_DISPATCHER
...
feature {NONE}
	...
	make (a_callback: OLDFONTENUMPROCW_CALLBACK) is
		require
			a_callback_not_void: a_callback /= Void
		do
			callback := a_callback
			set_oldfontenumprocw_entry_external (Current, $on_callback)
		end

feature {ANY}

	callback: OLDFONTENUMPROCW_CALLBACK

	c_dispatcher: POINTER is
		do
			Result := get_oldfontenumprocw_stub_external
		end

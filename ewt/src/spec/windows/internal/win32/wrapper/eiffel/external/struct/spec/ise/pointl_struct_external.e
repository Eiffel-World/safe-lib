...
-- wrapper for struct: struct _POINTL-- WARNING: could not find good typename, wrapper may contain errors

class POINTL_STRUCT_EXTERNAL
...
feature {NONE} -- Implementation
	...
	get_x_external (item: POINTER): INTEGER is
		...
		alias
			"ewg_struct_macro_struct__POINTL_member_get_x"
	...
	set_x_external (a_item: POINTER; a_value: INTEGER) is
		external
			...
			"C [macro <c\struct\ewg_struct_c_glue_code.h>]"
		alias
			"ewg_struct_macro_struct__POINTL_member_set_x"
	...
	get_y_external (item: POINTER): INTEGER is
		external
			...
			"C [macro <c\struct\ewg_struct_c_glue_code.h>]"
		alias
			"ewg_struct_macro_struct__POINTL_member_get_y"
	...
	set_y_external (a_item: POINTER; a_value: INTEGER) is
		external
			...
			"C [macro <c\struct\ewg_struct_c_glue_code.h>]"
		alias
			"ewg_struct_macro_struct__POINTL_member_set_y"

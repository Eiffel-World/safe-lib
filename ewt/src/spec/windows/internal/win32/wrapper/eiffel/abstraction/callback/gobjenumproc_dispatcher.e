...
feature {NONE}
	...
	make (a_callback: GOBJENUMPROC_CALLBACK) is
		require
			a_callback_not_void: a_callback /= Void
		do
			callback := a_callback
			set_gobjenumproc_entry_external (Current, $on_callback)
		end

feature {ANY}

	callback: GOBJENUMPROC_CALLBACK

	c_dispatcher: POINTER is
		do
			Result := get_gobjenumproc_stub_external
		end

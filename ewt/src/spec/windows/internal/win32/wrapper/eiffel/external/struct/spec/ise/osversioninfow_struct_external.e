...
-- wrapper for struct: struct _OSVERSIONINFOW-- WARNING: could not find good typename, wrapper may contain errors

class OSVERSIONINFOW_STRUCT_EXTERNAL
...
feature {NONE} -- Implementation
	...
	get_dwosversioninfosize_external (item: POINTER): INTEGER is
		...
		alias
			"ewg_struct_macro_struct__OSVERSIONINFOW_member_get_dwOSVersionInfoSize"
	...
	set_dwosversioninfosize_external (a_item: POINTER; a_value: INTEGER) is
		external
			...
			"C [macro <c\struct\ewg_struct_c_glue_code.h>]"
		alias
			"ewg_struct_macro_struct__OSVERSIONINFOW_member_set_dwOSVersionInfoSize"
	...
	get_dwmajorversion_external (item: POINTER): INTEGER is
		external
			...
			"C [macro <c\struct\ewg_struct_c_glue_code.h>]"
		alias
			"ewg_struct_macro_struct__OSVERSIONINFOW_member_get_dwMajorVersion"
	...
	set_dwmajorversion_external (a_item: POINTER; a_value: INTEGER) is
		external
			...
			"C [macro <c\struct\ewg_struct_c_glue_code.h>]"
		alias
			"ewg_struct_macro_struct__OSVERSIONINFOW_member_set_dwMajorVersion"
	...
	get_dwminorversion_external (item: POINTER): INTEGER is
		external
			...
			"C [macro <c\struct\ewg_struct_c_glue_code.h>]"
		alias
			"ewg_struct_macro_struct__OSVERSIONINFOW_member_get_dwMinorVersion"
	...
	set_dwminorversion_external (a_item: POINTER; a_value: INTEGER) is
		external
			...
			"C [macro <c\struct\ewg_struct_c_glue_code.h>]"
		alias
			"ewg_struct_macro_struct__OSVERSIONINFOW_member_set_dwMinorVersion"
	...
	get_dwbuildnumber_external (item: POINTER): INTEGER is
		external
			...
			"C [macro <c\struct\ewg_struct_c_glue_code.h>]"
		alias
			"ewg_struct_macro_struct__OSVERSIONINFOW_member_get_dwBuildNumber"
	...
	set_dwbuildnumber_external (a_item: POINTER; a_value: INTEGER) is
		external
			...
			"C [macro <c\struct\ewg_struct_c_glue_code.h>]"
		alias
			"ewg_struct_macro_struct__OSVERSIONINFOW_member_set_dwBuildNumber"
	...
	get_dwplatformid_external (item: POINTER): INTEGER is
		external
			...
			"C [macro <c\struct\ewg_struct_c_glue_code.h>]"
		alias
			"ewg_struct_macro_struct__OSVERSIONINFOW_member_get_dwPlatformId"
	...
	set_dwplatformid_external (a_item: POINTER; a_value: INTEGER) is
		external
			...
			"C [macro <c\struct\ewg_struct_c_glue_code.h>]"
		alias
			"ewg_struct_macro_struct__OSVERSIONINFOW_member_set_dwPlatformId"

class PROPENUMPROCW_DISPATCHER
...
feature {NONE}
	...
	make (a_callback: PROPENUMPROCW_CALLBACK) is
		require
			a_callback_not_void: a_callback /= Void
		do
			callback := a_callback
			set_propenumprocw_entry_external (Current, $on_callback)
		end

feature {ANY}

	callback: PROPENUMPROCW_CALLBACK

	c_dispatcher: POINTER is
		do
			Result := get_propenumprocw_stub_external
		end

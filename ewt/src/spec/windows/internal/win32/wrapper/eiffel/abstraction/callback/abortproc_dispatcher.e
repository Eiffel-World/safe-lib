...
feature {NONE}
	...
	make (a_callback: ABORTPROC_CALLBACK) is
		require
			a_callback_not_void: a_callback /= Void
		do
			callback := a_callback
			set_abortproc_entry_external (Current, $on_callback)
		end

feature {ANY}

	callback: ABORTPROC_CALLBACK

	c_dispatcher: POINTER is
		do
			Result := get_abortproc_stub_external
		end

...
--	]")
				...
				create my_decimal.make_from_string_ctx ("25.212", ctx)
				...
				insert.set_sql ("insert into TEST_DECIMAL VALUES (?, ?, ?, ?)")
				insert.set_parameters (<<decimal_18_0, decimal_18_2, decimal_5_3, decimal_18_4>>)
